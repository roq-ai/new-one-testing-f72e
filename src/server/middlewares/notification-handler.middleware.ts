...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'employee_data.update': {
    ...
    tenantPath: ['hotel', 'employee_data'],
    userPath: [],
  },
  'payroll.update': {
    roles: ['employee', 'menu'],
    key: 'payroll-info-update',
    tenantPath: ['hotel', 'user', 'payroll'],
    userPath: [],
  },
  'menu.delete': { roles: ['employee'], key: 'menu-data-delete', tenantPath: ['hotel', 'menu'], userPath: [] },
};

const ownerRoles: string[] = ['employee'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['employee', 'menu'];
