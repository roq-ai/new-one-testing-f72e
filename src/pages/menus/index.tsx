...
export function MenuListPage(props: MenuListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getMenus({
        relations: ['hotel', 'menu_invitation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('hotel', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('menu_invitation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'menu_invitation',
          header: 'Menu Invitation',
          accessorKey: 'menu_invitation',
          cell: ({ row: { original: record } }: any) => record?._count?.menu_invitation,
        }
      : null,
