...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`New One Testing`}</title>

        <meta
          name="description"
          content="Streamline Your Workforce Management with New One Testing - Unifying Employee Data and Payroll Information for Seamless Operations"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYW5hZ2VtZW50fGVufDB8fHx8MTY5MzgxOTE5Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Workforce Management with New One Testing - Unifying Employee Data and Payroll Information for Seamless Operations`}
            </Text>
            <Box
