...
export function HotelListPage(props: HotelListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getHotels({
        relations: ['user', 'employee_data.count', 'menu.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('employee_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'employee_data',
          header: 'Employee Data',
          accessorKey: 'employee_data',
          cell: ({ row: { original: record } }: any) => record?._count?.employee_data,
        }
      : null,
